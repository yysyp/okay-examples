...
import ps.demo.upload2.MainApplication;
...
public class MainRestTest {
    static String baseUrl = "http://localhost:18264";
    ...
    public void test_actuator() {
        ...
        //Assertions.assertEquals("http://localhost:18264/actuator/prometheus",
