...
public class FileUploadController {
    ...
    public static final String UPLOAD_PATH = "upload-folder";
    ...
    public ResponseEntity<Map<String, String>> uploadBig(@RequestParam Long chunkSize, @RequestParam Integer totalNumber, @RequestParam Long chunkNumber, @RequestParam String md5, @RequestParam MultipartFile file) throws IOException, IOException {
        log.info("Upload Big file started...");
        //文件存放位置
    ...
    //https://juejin.cn/post/7266265543412351030
