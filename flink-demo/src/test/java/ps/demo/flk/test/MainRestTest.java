...
import ps.demo.flk.MainApplication;
...
public class MainRestTest {
    static String baseUrl = "http://localhost:172";
    ...
    public void test_actuator() {
        ...
        //Assertions.assertEquals("http://localhost:172/actuator/prometheus",
